...
export const LISTAS_EN = {
    ...
    sustantivos_forzados: ['garden', 'fish', 'water', 'light', 'plant',
        ...
        'time', 'love', 'work', 'play', 'run', 'jump',
        'walk', 'talk', 'drink', 'sleep', 'dream',
        'rest', 'mind', 'care', 'help', 'hope', 'change',
        'life', 'death', 'fire', 'air', 'earth', 'space',
        'time', 'night', 'day', 'morning', 'evening',
        'summer', 'winter', 'spring', 'fall', 'year',
        'month', 'week', 'hour', 'minute', 'second'],
    numerales_letras_en: [
...
export const LISTAS_ES = {
    ...
    sustantivos_forzados: [
        ...
        'ocupante','ocupantes','dirigente','dirigentes',
        'dependiente','dependientes','creyente','creyentes',
        'oyente','oyentes','sobreviviente','sobrevivientes',
        'adolescente','adolescentes','docente','docentes',
        'componente','componentes','corriente','corrientes',],
    numerales_letras_es: [
